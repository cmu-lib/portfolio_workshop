...
Download [the workshop files](https://cmu_lib.github.io/portfolio_workshop/OpenRefine_Materials/files/20201001_OpenRefine_Workshop_files.zip) and save them in a folder on your desktop. Make sure to extract the files from the zip file.  
