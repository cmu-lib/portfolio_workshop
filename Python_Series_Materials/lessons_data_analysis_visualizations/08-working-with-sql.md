...
The [sqlite3][sqlite3] module provides a straightforward interface for interacting with
...
becomes more noticeable as the size of the dataset grows (see for example [these benchmarks][these benchmarks]).
