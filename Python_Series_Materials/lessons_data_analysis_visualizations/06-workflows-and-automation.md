...
3. Instead of splitting out the data by years, a colleague wants to do analyses on each species separately. How would you write a unique CSV file for each species?
...
3. 
   ...
   for species in surveys_df['species_id'].dropna().unique():
       ...
       filename = 'data/species_files/surveys' + species + '.csv'
...
### Take Home Challenge - Modifying functions
