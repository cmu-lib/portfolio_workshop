...
*   Python reports an `IndexError` if we attempt to access a value that doesn't exist.
    *   This is a kind of [runtime error](#runtime-error).
...
## <a id="runtime-error"></a> Python reports a runtime error when something goes wrong while a program is executing.
